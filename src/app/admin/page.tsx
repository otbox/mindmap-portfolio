...
import { ReactFlow, applyNodeChanges, applyEdgeChanges, addEdge, NodeChange, EdgeChange, Controls, ReactFlowProvider, Background, BackgroundVariant, Panel } from '@xyflow/react';
            ...
            <ReactFlowProvider>
                ...
                >
                    ...
                    variant={BackgroundVariant.Dots}
                                ...
                                size={1}
                                color="#ccc" />
                    <Panel position='bottom-right'><CreateNodeButton/></Panel>
                </ReactFlow>
            </ReactFlowProvider>
        </div>
    )
